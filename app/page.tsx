      ...
      <main className="min-h-screen bg-black text-white overflow-hidden scroll-smooth">
        ...
        {openChat && (
          <div className="fixed bottom-24 right-6 z-50 flex h-[600px] max-h-[calc(90vh-120px)] w-[380px] max-w-[calc(100vw-48px)] flex-col overflow-hidden rounded-[32px] border border-white/10 bg-[#0a0a0a]/95 shadow-2xl backdrop-blur-2xl">
            ...
            <div
              ref={chatRef}
              className="pointer-events-auto flex-1 space-y-4 overflow-y-auto px-4 py-5"
            >
        ...
        <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-black/40 backdrop-blur-2xl">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
            ...
            <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  <div className="rounded-2xl bg-cyan-400 px-5 py-3 font-bold text-black">
          ...
          <div className="relative z-10 mx-auto max-w-7xl grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm backdrop-blur-xl mb-6">
                Echo Media Wave • PR • Influencer Marketing • Brand Growth
                Agency
              </div>
              ...
              <p className="mt-6 text-lg text-gray-300 leading-relaxed max-w-2xl">
                We help brands grow through strategic PR campaigns, influencer
                collaborations, viral social media marketing, creator
                partnerships, and modern digital storytelling.
              </p>
              ...
              <div className="rounded-[40px] border border-white/10 bg-white/5 backdrop-blur-2xl p-8 shadow-2xl">
                ...
                <div className="mt-6 rounded-3xl border border-white/10 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 p-6">
                  <p className="text-lg font-semibold">
                    Trusted by influencers, startups, beauty brands, personal
                    brands, fashion labels, and modern businesses.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              ...
              <p className="mt-5 text-gray-400 max-w-2xl mx-auto">
                We combine PR, content, creators, and digital growth strategies
          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-gray-400">
                Creative campaigns and digital projects delivered for modern
                brands.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="mt-3 text-gray-400 leading-relaxed">
                      Social media growth, influencer collaborations, and
                      creative branding campaign.
                    </p>
                  </div>
                </div>
              ))}
              ...
              <div className="grid lg:grid-cols-2 gap-14 items-center">
                <div>
                  ...
                  <p className="mt-6 text-gray-300 leading-relaxed">
                    We create high-converting campaigns powered by storytelling,
                    influencer collaborations, viral content strategies, and
                    modern PR techniques.
                  </p>
                </div>
        ...
        <section id="contact" className="px-6 py-24">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mt-6 text-lg text-gray-400 leading-relaxed">
              Launch your next PR campaign with Echo Media Wave and build a
